...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <?php endif; ?>
            <?php if(auth()->user()->hasAccess('tpq.prestasi')): ?>
            <a href="<?php echo e(route('tpq.prestasi.index')); ?>">
                <span class="nav-icon">📖</span> Kartu Prestasi
            </a>
            <?php endif; ?>
            <a href="<?php echo e(route('tpq.master-hafalan.index')); ?>" class="active">
    ...
    <main class="main">
        ...
        <div class="grid">
            ...
            <div class="section">
                ...
                <form id="hafalanForm" action="<?php echo e(route('tpq.master-hafalan.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($item->kategori === 'surah_pendek'): ?>
                                    ...
                                    <td style="text-align: center;">
                                        <button class="btn-action" onclick="editHafalan(<?php echo e(json_encode($item)); ?>)">Edit</button>
                                        <form action="<?php echo e(route('tpq.master-hafalan.destroy', $item->id)); ?>" method="POST" style="display:inline-block;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data master ini?')">
                                            <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function resetForm() {
            ...
            form.action = "<?php echo e(route('tpq.master-hafalan.store')); ?>";
...
<?php /**PATH C:\xampp\htdocs\masjid-baginda\resources\views/tpq/master_hafalan.blade.php ENDPATH**/ ?>