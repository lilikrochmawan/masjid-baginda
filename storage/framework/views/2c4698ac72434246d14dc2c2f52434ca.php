...
<body>
    ...
    <main class="main">
        ...
        <!-- Navigation Tabs -->
        <div class="tabs-nav">
            <a href="<?php echo e(route('tpq.keuangan.spp.index')); ?>" class="tab-btn active">Pembayaran SPP</a>
            <a href="<?php echo e(route('tpq.keuangan.rekap.index')); ?>" class="tab-btn">Rekap SPP</a>
            <a href="<?php echo e(route('tpq.keuangan.kas.index')); ?>" class="tab-btn">Arus Kas (Cashflow)</a>
        ...
        <div class="section">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 12px; border-bottom: 1px solid #e6f4ed; padding-bottom: 12px;">
                <h2 style="margin-bottom: 0;">Peta Pembayaran SPP Tahun <?php echo e($year); ?></h2>
                ...
                <div style="display: flex; gap: 12px; align-items: center; margin: 0; flex-wrap: wrap;">
                    ...
                    <form class="filters" action="<?php echo e(route('tpq.keuangan.spp.index')); ?>" method="GET" style="margin: 0; display: flex; gap: 12px; align-items: center;">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th>Kelas</th>
                            <?php for($m = 1; $m <= 12; $m++): ?>
                                <th><?php echo e(substr(\Carbon\Carbon::create()->month($m)->format('F'), 0, 3)); ?></th>
                            <?php endfor; ?>
                        </tr>
                    </thead>
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $santris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $santri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <?php if($santri->kelas): ?>
                                        <span style="font-size: 12px; color: #047857; font-weight:600;">🏫 <?php echo e($santri->kelas->nama_kelas); ?></span>
                                    <?php else: ?>
                                ...
                                <?php for($m = 1; $m <= 12; $m++): ?>
                                    ...
                                    <td>
                                        <?php if($payment): ?>
                                            <span class="status-paid" title="Lunas: Rp <?php echo e(number_format($payment->jumlah, 0, ',', '.')); ?>&#10;Tgl Bayar: <?php echo e(date('d/m/Y', strtotime($payment->tanggal_bayar))); ?>">
                                                Lunas
                                            </span>
                                        <?php else: ?>
                                            <button class="btn-pay" onclick="openPaymentModal(<?php echo e($santri->id); ?>, '<?php echo e($santri->nama_santri); ?>', <?php echo e($m); ?>, <?php echo e($year); ?>)">
                                                Bayar
                                            </button>
                                        <?php endif; ?>
                                    </td>
    ...
    <div class="modal" id="payment-modal">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('tpq.keuangan.spp.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="tanggal_bayar" name="tanggal_bayar" value="<?php echo e(date('Y-m-d')); ?>" required>
                    </div>
                </div>
...
<?php /**PATH C:\xampp\htdocs\masjid-baginda\resources\views/tpq/keuangan/spp.blade.php ENDPATH**/ ?>