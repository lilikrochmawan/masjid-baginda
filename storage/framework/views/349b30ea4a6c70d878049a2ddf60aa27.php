                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(150px, 1fr)); gap: 8px; margin-top: 4px; padding: 12px; background: #fbfffe; border: 1px solid #d1e7dd; border-radius: 12px; max-height: 150px; overflow-y: auto;">
                            <?php $__currentLoopData = $gurus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label style="display: flex; align-items: center; gap: 8px; font-weight: normal; font-size: 13.5px; margin-bottom: 0; cursor: pointer;">
                                    <input type="checkbox" name="tb_guru_ids[]" value="<?php echo e($g->id); ?>" class="guru-checkbox" style="width: auto;">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $kelas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if($item->gurus->isNotEmpty()): ?>
                                            <div style="display: flex; flex-direction: column; gap: 4px;">
                                                <?php $__currentLoopData = $item->gurus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <span style="color:#0f766e; font-weight:600; display: inline-flex; align-items: center; gap: 6px;">👨‍🏫 <?php echo e($g->nama_guru); ?></span>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        <?php else: ?>
                                    ...
                                    <td>
                                        <button class="btn-action" onclick='editKelas(<?php echo json_encode($item, 15, 512) ?>)'>Ubah</button>
