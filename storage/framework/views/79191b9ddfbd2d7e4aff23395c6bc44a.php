...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('keuangan.index')); ?>" class="active">
            ...
            <?php endif; ?>
            <a href="<?php echo e(route('keuangan.event.index')); ?>">
                    ...
                    <form action="<?php echo e(route('keuangan.store')); ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select id="tb_penerimaan_kaleng_id" name="tb_penerimaan_kaleng_id">
                                ...
                                <?php $__currentLoopData = $penerimaanOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($option->id); ?>" data-amount="<?php echo e($option->jumlah); ?>" <?php echo e(old('tb_penerimaan_kaleng_id') == $option->id ? 'selected' : ''); ?>>
                                        <?php echo e($option->tanggal_penerimaan); ?> - <?php echo e($option->jumlah); ?> - <?php echo e($option->user?->name ?? '-'); ?>
                ...
                <div>
                    <div class="summary-grid">
                        <div class="summary-card">
                            ...
                            <strong><?php echo e(ucfirst($hakakses->nama_hakakses)); ?></strong>
                        </div>
                        <div class="summary-card">
                            <span>Pending kas masuk</span>
                            <strong><?php echo e($pendingKasCount); ?></strong>
                        </div>
                    </div>

                    <?php if($hakakses->nama_hakakses === 'bendahara' && $pendingKas->isNotEmpty()): ?>
                        <div class="section" style="margin-top: 16px;">
                            <h2>Notifikasi Konfirmasi</h2>
                            <p style="font-size:13px;color:#6b7280;margin-bottom:12px;">Ada <?php echo e($pendingKasCount); ?> transaksi kas masuk menunggu konfirmasi.</p>
                            <div class="table-wrapper">
                                <table>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $pendingKas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($loop->iteration); ?></td>
                                                <td><?php echo e($kas->tanggal_kas); ?></td>
                                                <td><?php echo e($kas->jumlah); ?></td>
                                                <td><?php echo e($kas->keterangan ?? '-'); ?></td>
                                                <td><?php echo e($kas->user?->name ?? '-'); ?></td>
                                                <td>
                                                    <form action="<?php echo e(route('keuangan.confirm', $kas->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
        ...
        <div class="section">
            ...
            <div class="table-wrapper">
                <table>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $kasEntries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($loop->iteration); ?></td>
                                <td><?php echo e($item->tanggal_kas); ?></td>
                                <td><?php echo e(ucfirst($item->tipe)); ?></td>
                                <td><?php echo e($item->jumlah); ?></td>
                                <td><?php echo e($item->penerimaanKaleng?->tanggal_penerimaan ? 'Penerimaan ' . $item->penerimaanKaleng->tanggal_penerimaan : '-'); ?></td>
    ...
    <script>
        ...
        function setPenerimaanKas() {
            ...
            if (penerimaanSelect.value) {
                ...
                jumlahInput.value = '<?php echo e(old('jumlah') ?? ''); ?>';
                keteranganInput.value = '<?php echo e(old('keterangan') ?? ''); ?>';
            }
        }
...
<?php /**PATH C:\xampp\htdocs\masjid-baginda\resources\views/keuangan/index.blade.php ENDPATH**/ ?>