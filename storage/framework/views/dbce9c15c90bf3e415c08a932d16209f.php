...
<body>
    ...
    <main class="main">
            ...
            <form action="<?php echo e(route('settings.update')); ?>" method="POST">
                ...
                <div class="card">
                    ...
                    <div class="form-group" style="display: flex; align-items: center; justify-content: space-between; background: #f8fafc; padding: 15px; border-radius: 10px; border: 1px solid #e2e8f0; margin-bottom: 20px;">
                        ...
                        <label class="switch">
                            <input type="checkbox" name="whatsapp_status" value="1" <?php echo e(old('whatsapp_status', $setting->whatsapp_status ?? 1) ? 'checked' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="password" id="fonnte_token" name="fonnte_token" value="<?php echo e(old('fonnte_token', $setting->fonnte_token)); ?>" placeholder="Masukkan Token API Fonnte Anda">
                ...
                <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="midtrans_client_id" name="midtrans_client_id" value="<?php echo e(old('midtrans_client_id', $setting->midtrans_client_id)); ?>" placeholder="Masukkan Midtrans Client ID">
                    </div>

                    <div class="form-group">
                        <label for="midtrans_server_key">Midtrans Server Key</label>
                        <div class="input-group">
                            <input type="password" id="midtrans_server_key" name="midtrans_server_key" value="<?php echo e(old('midtrans_server_key', $setting->midtrans_server_key)); ?>" placeholder="Masukkan Midtrans Server Key">
                    ...
                    <div class="form-group">
                        ...
                        <select id="midtrans_environment" name="midtrans_environment" required>
                            <option value="sandbox" <?php echo e(old('midtrans_environment', $setting->midtrans_environment) === 'sandbox' ? 'selected' : ''); ?>>Sandbox (Development/Testing)</option>
                            <option value="production" <?php echo e(old('midtrans_environment', $setting->midtrans_environment) === 'production' ? 'selected' : ''); ?>>Production (Live/Asli)</option>
                        </select>
                    </div>
                </div>

                <div class="form-actions">
                    <a href="<?php echo e(route('dashboard')); ?>" class="button-secondary">Kembali ke Dashboard</a>
        ...
        <div id="tab-content-templates" style="display: none;">
            <form action="<?php echo e(route('settings.templates.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card">
                        <div class="card-header">
                            <h2><span>📝</span> 
                                <?php if($template->key === 'spp_kuitansi'): ?>
                                    Kuitansi SPP TPQ
                                <?php elseif($template->key === 'koin_scan'): ?>
                                    Kuitansi Scan Koin Baginda
                                <?php elseif($template->key === 'tpq_absensi'): ?>
                                    Notifikasi Absensi TPQ
                                <?php elseif($template->key === 'tpq_prestasi_sorogan'): ?>
                                    Notifikasi Prestasi Sorogan
                                <?php elseif($template->key === 'tpq_prestasi_hafalan'): ?>
                                    Notifikasi Prestasi Hafalan
                                <?php else: ?>
                                    <?php echo e($template->key); ?>
                        ...
                        <input type="hidden" name="templates[<?php echo e($loop->index); ?>][key]" value="<?php echo e($template->key); ?>">

                        <div class="form-group">
                            <label for="template_<?php echo e($template->key); ?>">Isi Pesan WhatsApp</label>
                            <textarea id="template_<?php echo e($template->key); ?>" name="templates[<?php echo e($loop->index); ?>][template]" rows="8" style="width:100%; padding:12px; border-radius:10px; border:1px solid #cbd5e1; font-family: 'Courier New', Courier, monospace; font-size:14px; line-height:1.5;" required><?php echo e(old('templates.'.$loop->index.'.template', $template->template)); ?></textarea>
                        </div>
                        ...
                        <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 10px; padding: 14px; margin-top: 12px;">
                            ...
                            <div style="display:flex; flex-wrap:wrap; gap:8px;">
                                <?php if($template->key === 'spp_kuitansi'): ?>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_santri}')"><code>{nama_santri}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{bulan}')"><code>{bulan}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{tahun}')"><code>{tahun}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{jumlah}')"><code>{jumlah}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{tanggal_bayar}')"><code>{tanggal_bayar}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_wali}')"><code>{nama_wali}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{penerima}')"><code>{penerima}</code></span>
                                <?php elseif($template->key === 'koin_scan'): ?>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_pemilik}')"><code>{nama_pemilik}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{kode_kaleng}')"><code>{kode_kaleng}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_kaleng}')"><code>{nama_kaleng}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{tanggal_ambil}')"><code>{tanggal_ambil}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_petugas}')"><code>{nama_petugas}</code></span>
                                <?php elseif($template->key === 'tpq_absensi'): ?>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_santri}')"><code>{nama_santri}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{tanggal}')"><code>{tanggal}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{status}')"><code>{status}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{keterangan}')"><code>{keterangan}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_wali}')"><code>{nama_wali}</code></span>
                                <?php elseif($template->key === 'tpq_prestasi_sorogan'): ?>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_santri}')"><code>{nama_santri}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{tanggal}')"><code>{tanggal}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{materi_detail}')"><code>{materi_detail}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{keterangan}')"><code>{keterangan}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_petugas}')"><code>{nama_petugas}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_wali}')"><code>{nama_wali}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{link_prestasi}')"><code>{link_prestasi}</code></span>
                                <?php elseif($template->key === 'tpq_prestasi_hafalan'): ?>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_santri}')"><code>{nama_santri}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{tanggal}')"><code>{tanggal}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_hafalan}')"><code>{nama_hafalan}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{kategori}')"><code>{kategori}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{keterangan}')"><code>{keterangan}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_petugas}')"><code>{nama_petugas}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{nama_wali}')"><code>{nama_wali}</code></span>
                                    <span class="placeholder-tag" onclick="insertPlaceholder('template_<?php echo e($template->key); ?>', '{link_prestasi}')"><code>{link_prestasi}</code></span>
                        ...
                        <details style="margin-top: 16px; background: #f1f5f9; border: 1px solid #cbd5e1; border-radius: 10px; overflow: hidden;">
                            ...
                            <div style="padding: 16px; border-top: 1px solid #cbd5e1; font-size: 13.5px; background: white;">
                                ...
                                <div class="form-group" style="margin-bottom: 12px;">
                                    <label for="waba_name_<?php echo e($template->key); ?>" style="font-size: 13px; font-weight: 600;">Nama Template (cth: pemberitahuan_tagihan)</label>
                                    <input type="text" id="waba_name_<?php echo e($template->key); ?>" name="templates[<?php echo e($loop->index); ?>][waba_template_name]" value="<?php echo e(old('templates.'.$loop->index.'.waba_template_name', $template->waba_template_name)); ?>" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #cbd5e1;" placeholder="cth: tagihan_internet">
                                </div>
                                
                                <div class="form-group" style="margin-bottom: 12px;">
                                    <label for="waba_lang_<?php echo e($template->key); ?>" style="font-size: 13px; font-weight: 600;">Bahasa Template (default: id)</label>
                                    <input type="text" id="waba_lang_<?php echo e($template->key); ?>" name="templates[<?php echo e($loop->index); ?>][waba_template_language]" value="<?php echo e(old('templates.'.$loop->index.'.waba_template_language', $template->waba_template_language ?? 'id')); ?>" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #cbd5e1;">
                                ...
                                <div class="form-group" style="margin-bottom: 0;">
                                    <label for="waba_vars_<?php echo e($template->key); ?>" style="font-size: 13px; font-weight: 600;">Urutan Variabel Template (pisahkan dengan koma)</label>
                                    <input type="text" id="waba_vars_<?php echo e($template->key); ?>" name="templates[<?php echo e($loop->index); ?>][waba_template_variables]" value="<?php echo e(old('templates.'.$loop->index.'.waba_template_variables', $template->waba_template_variables)); ?>" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #cbd5e1;" placeholder="nama,jumlah,tanggal_bayar">
        ...
        <div id="tab-content-login" style="display: none;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 20px;">
                    <div>
                        ...
                        <div style="border-radius: 12px; overflow: hidden; border: 2px solid #cbd5e1; height: 160px; background: #f8fafc; display: flex; align-items: center; justify-content: center; position: relative; padding: 15px;">
                            <?php if($setting->logo): ?>
                                <img src="<?php echo e(asset('storage/' . $setting->logo)); ?>" alt="Logo" style="max-width: 100%; max-height: 100%; object-fit: contain;">
                            <?php else: ?>
                                <img src="<?php echo e(asset('images/image.png')); ?>" alt="Default Logo" style="max-width: 100%; max-height: 100%; object-fit: contain;">
                            <?php endif; ?>
                            <div style="position: absolute; bottom: 10px; left: 10px; background: rgba(15, 23, 42, 0.75); color: white; padding: 4px 10px; border-radius: 20px; font-size: 11px; font-weight: 600;">
                                <?php echo e($setting->logo ? 'Logo Kustom' : 'Logo Default'); ?>
                    ...
                    <div style="display: flex; flex-direction: column; justify-content: center;">
                        <form action="<?php echo e(route('settings.logo.update')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                        ...
                        <?php if($setting->logo): ?>
                            <form action="<?php echo e(route('settings.logo.reset')); ?>" method="POST" style="margin-top: 12px;">
                                <?php echo csrf_field(); ?>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 30px; margin-bottom: 20px;">
                    <div>
                        ...
                        <div style="border-radius: 12px; overflow: hidden; border: 2px solid #cbd5e1; height: 220px; background: #f1f5f9; display: flex; align-items: center; justify-content: center; position: relative;">
                            <?php if($setting->foto_masjid): ?>
                                <img src="<?php echo e(asset('storage/' . $setting->foto_masjid)); ?>" alt="Login Background" style="width: 100%; height: 100%; object-fit: cover;">
                            <?php else: ?>
                                <img src="<?php echo e(asset('images/default_mosque_bg.png')); ?>" alt="Default Background" style="width: 100%; height: 100%; object-fit: cover;">
                            <?php endif; ?>
                            <div style="position: absolute; bottom: 10px; left: 10px; background: rgba(15, 23, 42, 0.75); color: white; padding: 4px 10px; border-radius: 20px; font-size: 11px; font-weight: 600;">
                                <?php echo e($setting->foto_masjid ? 'Gambar Kustom' : 'Gambar Default'); ?>
                    ...
                    <div style="display: flex; flex-direction: column; justify-content: center;">
                        <form action="<?php echo e(route('settings.login-bg.update')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="form-group" style="margin-bottom: 20px;">
                        ...
                        <?php if($setting->foto_masjid): ?>
                            <form action="<?php echo e(route('settings.login-bg.reset')); ?>" method="POST" style="margin-top: 12px;">
                                <?php echo csrf_field(); ?>
            ...
            <div class="card" style="margin-top: 24px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1.2fr; gap: 30px;">
                    <!-- Left: Upload Form -->
                    <div>
                        <form action="<?php echo e(route('settings.pengumuman.upload')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                    ...
                                    <div style="display: flex; align-items: center; justify-content: space-between; background: #f8fafc; border: 1px solid #e2e8f0; padding: 10px; border-radius: 12px; gap: 12px;">
                                        <div style="display: flex; align-items: center; gap: 12px; flex: 1; min-width: 0;">
                                            <div style="width: 80px; height: 45px; border-radius: 6px; overflow: hidden; background: #e2e8f0; flex-shrink: 0; border: 1px solid #cbd5e1;">
                                                <img src="<?php echo e(asset('storage/' . $item->image_path)); ?>" alt="Preview" style="width: 100%; height: 100%; object-fit: cover;">
                                            </div>
                                            <div style="min-width: 0; flex: 1;">
                                                <div style="font-size: 13px; font-weight: 600; color: #1e293b; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                                    <?php echo e($item->title ?? 'Pengumuman #' . $item->id); ?>

                                                </div>
                                                <div style="font-size: 11px; color: #64748b;">
                                                    Diunggah: <?php echo e($item->created_at->format('d M Y')); ?>

                                                </div>
                                            </div>
                                        </div>
                                        <form action="<?php echo e(route('settings.pengumuman.delete', $item->id)); ?>" method="POST" style="margin:0;">
                                            <?php echo csrf_field(); ?>
            ...
            <div style="display: grid; grid-template-columns: 1fr 2fr; gap: 24px; align-items: start;">
                ...
                <div style="display: flex; flex-direction: column; gap: 20px;">
                    ...
                    <div class="card">
                        ...
                        <form action="<?php echo e(route('settings.wa-groups.store')); ?>" method="POST" style="margin-top: 15px;">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                    ...
                    <div style="margin-top: 15px;">
                        ...
                        <?php else: ?>
                            <table style="width: 100%; border-collapse: collapse;">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $whatsappGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr style="border-bottom: 1px solid #e2e8f0;">
                                            <td style="padding: 10px; font-weight: bold; color: #334155;"><?php echo e($group->group_name); ?></td>
                                            <td style="padding: 10px; color: #64748b; font-family: monospace;"><?php echo e($group->group_id); ?></td>
                                            <td style="padding: 10px; text-align: center;">
                                                <form action="<?php echo e(route('settings.wa-groups.destroy', $group->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus grup ini?')">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
    ...
    <script>
        ...
        function syncFonnteGroups() {
            ...
            const url = "<?php echo e(route('operasional.broadcast.wa-groups')); ?>";
                    ...
                    if (data.success) {
                        ...
                        groups.forEach(g => {
                            ...
                            item.innerHTML = `
                                ...
                                <form action="<?php echo e(route('settings.wa-groups.store')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\masjid-baginda\resources\views/settings/index.blade.php ENDPATH**/ ?>