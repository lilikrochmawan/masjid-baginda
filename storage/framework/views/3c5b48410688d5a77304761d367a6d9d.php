            ...
            <div class="section">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 12px; border-bottom: 1px solid #e6f4ed; padding-bottom: 12px;">
                    ...
                    <div style="display: flex; gap: 12px; align-items: center; margin: 0; flex-wrap: wrap;">
                        <input type="text" id="tableSearchInput" placeholder="Cari nama / NIS / alamat..." style="padding: 10px 14px; border-radius: 10px; border: 1px solid #d1e7dd; font-size: 13.5px; background: #fbfffe; color: #103a2d; min-width: 200px; outline: none; transition: border-color 0.2s;">
                        
                        <form action="<?php echo e(route('tpq.santri.index')); ?>" method="GET" style="display: flex; gap: 8px; align-items: center; margin: 0;">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $santris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $santri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><strong><?php echo e($santri->nama_santri); ?></strong></td>
                                    <td>
                                        <?php if($santri->kelas): ?>
        ...
        function updateTable() {
            ...
            if (filteredRows.length === 0) {
                if (!noDataRow) {
                    ...
                    noDataRow.innerHTML = '<td colspan="11" style="text-align:center; color:#9ca3af; padding: 20px 0;">Tidak ada data santri yang cocok.</td>';
