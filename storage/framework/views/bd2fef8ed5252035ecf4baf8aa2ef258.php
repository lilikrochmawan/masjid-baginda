...
<a href="<?php echo e(route('tpq.guru.index')); ?>" class="active">
...
<?php endif; ?>
    ...
    <main class="main">
        ...
        <div class="grid">
            ...
            <div class="section" id="form-container">
                ...
                <form id="guru-form" action="<?php echo e(route('tpq.guru.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $gurus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guru): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td><strong><?php echo e($guru->nama_guru); ?></strong></td>
                                    <td><?php echo e($guru->no_hp ?? '-'); ?></td>
                                    <td><?php echo e($guru->alamat ?? '-'); ?></td>
                                    <td>
                                        <?php if($guru->user): ?>
                                            <span style="font-size:12px; color:#0f766e;">👤 <?php echo e($guru->user->name); ?></span>
                                        <?php else: ?>
                                            <span style="font-size:12px; color:#9ca3af;">Tidak ada</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <button class="btn-action" onclick='editGuru(<?php echo json_encode($guru, 15, 512) ?>)'>Ubah</button>
                                        <form action="<?php echo e(route('tpq.guru.destroy', $guru->id)); ?>" method="POST" style="display:inline; margin-left: 4px;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus guru ini?')">
                                            <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function editGuru(guru) {
            ...
            form.action = "<?php echo e(route('tpq.guru.update', ':id')); ?>".replace(':id', guru.id);
        ...
        function resetForm() {
            ...
            form.action = "<?php echo e(route('tpq.guru.store')); ?>";
...
<?php /**PATH C:\xampp\htdocs\masjid-baginda\resources\views/tpq/guru.blade.php ENDPATH**/ ?>