...
<body>
    ...
    <main class="main">
        ...
        <div class="section">
            ...
            <form action="<?php echo e(route('keuangan.event.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo e($event->tanggal_mulai ?? '-'); ?> s/d <?php echo e($event->tanggal_selesai ?? '-'); ?>
                                ...
                                <td>
                                    <a href="<?php echo e(route('keuangan.event.show', $event->id)); ?>" class="button-primary" style="padding: 6px 12px; font-size: 12px; text-decoration: none;">Kelola Keuangan</a>
                                </td>
                            </tr>
...
<?php /**PATH C:\xampp\htdocs\masjid-baginda\resources\views/keuangan/event/index.blade.php ENDPATH**/ ?>