        ...
        <div class="section">
            ...
            <div class="summary-grid">
                <div class="summary-card">
                    ...
                    <strong>Rp <?php echo e(number_format($totalMasuk, 0, ',', '.')); ?></strong>
                </div>
                <div class="summary-card">
                    <span>Total Kas Keluar</span>
                    <strong>Rp <?php echo e(number_format($totalKeluar, 0, ',', '.')); ?></strong>
                </div>
                <div class="summary-card">
                    <span>Saldo Keseluruhan</span>
                    <strong>Rp <?php echo e(number_format($overallNet, 0, ',', '.')); ?></strong>
                </div>
            </div>
