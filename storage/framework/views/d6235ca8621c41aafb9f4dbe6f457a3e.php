...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('keuangan.laporan')); ?>" class="active">
    ...
    <main class="main">
        <div class="kop-header">
            <div class="kop-logo">
                    <img src="<?php echo e(asset('images/image.png')); ?>" alt="Masjid Baginda" class="kop-logo-img">
            </div>
            <div class="kop-text">
        ...
        <div class="page-title"><h1>Laporan Keuangan <?php echo e($periodeLabel); ?> </h1></div>

        <div class="section">
            <form class="filters" action="<?php echo e(route('keuangan.laporan')); ?>" method="GET">
                <label>
                    Periode
                    <select name="periode">
                        <option value="daily"   <?php echo e($periode === 'daily'   ? 'selected' : ''); ?>>Harian</option>
                ...
                <label>
                    Tanggal referensi
                    <input type="date" name="date" value="<?php echo e($selectedDate->format('Y-m-d')); ?>">
                </label>
            ...
            <div class="summary-grid">
                ...
                <div class="summary-card">
                    ...
                    <strong><?php echo e(number_format($overallNet, 0, ',', '.')); ?></strong>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\masjid-baginda\resources\views/keuangan/laporan.blade.php ENDPATH**/ ?>