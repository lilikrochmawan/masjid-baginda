...
<a href="<?php echo e(route('tpq.laporan.index')); ?>" class="active">
    ...
    <main class="main">
        ...
        <div class="print-header">
            <div class="print-logo-container">
                <img src="<?php echo e(asset('images/image.png')); ?>" class="print-logo" alt="Masjid Baginda">
                <div>
        ...
        <div class="section filter-section">
            <form method="GET" action="<?php echo e(route('tpq.laporan.index')); ?>">
                <div class="filter-row">
                    <div class="filter-group">
                        <label for="periode">Periode Laporan</label>
                        <select id="periode" name="periode" onchange="this.form.submit()">
                            <option value="weekly" <?php echo e($periode === 'weekly' ? 'selected' : ''); ?>>Mingguan</option>
                            <option value="monthly" <?php echo e($periode === 'monthly' ? 'selected' : ''); ?>>Bulanan</option>
                            <option value="yearly" <?php echo e($periode === 'yearly' ? 'selected' : ''); ?>>Tahunan</option>
                        </select>
                    </div>
                    ...
                    <div class="filter-group">
                        ...
                        <input type="date" id="tanggal" name="tanggal" value="<?php echo e($selectedDate->toDateString()); ?>" onchange="this.form.submit()">
                    </div>
                </div>
            </form>
        </div>
                ...
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 20px; flex-wrap:wrap; gap:10px;">
                    <h2>
                        ...
                        <?php if($periode === 'weekly'): ?>
                            Mingguan (Minggu Ke-<?php echo e($selectedDate->weekOfYear); ?>, <?php echo e($monthIndo); ?> <?php echo e($selectedDate->year); ?>)
                        <?php elseif($periode === 'monthly'): ?>
                            Bulanan (<?php echo e($monthIndo); ?> <?php echo e($selectedDate->year); ?>)
                        <?php else: ?>
                            Tahunan (Tahun <?php echo e($selectedDate->year); ?>)
                        <?php endif; ?>
                    </h2>
                    <div style="display:flex; gap:10px; align-items:center;">
                        <span style="font-weight:600; color:#0f766e; background:#e6f7f0; padding:6px 12px; border-radius:8px;">
                            Kelas: <?php echo e($classes->firstWhere('id', $selectedClassId)?->nama_kelas); ?>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <?php if($periode === 'weekly' || $periode === 'monthly'): ?>
                                    <?php $__currentLoopData = $dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <th style="min-width: 40px; font-size:11px;">
                                            <?php echo e(date('d', strtotime($date))); ?><br>
                                            <span style="font-size:9px; color:#6b7280;"><?php echo e(date('D', strtotime($date))); ?></span>
                                        </th>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php elseif($periode === 'yearly'): ?>
                                    <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mNum => $mName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <th style="min-width: 55px; font-size:11px;"><?php echo e(substr($mName, 0, 3)); ?></th>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php endif; ?>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $matrix; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $santriId => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td class="student-name"><?php echo e($row['santri']->nama_santri); ?></td>
                                    
                                    <?php if($periode === 'weekly' || $periode === 'monthly'): ?>
                                        <?php $__currentLoopData = $dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php $status = $row['attendance'][$date]; ?>
                                            <td>
                                                <?php if($status !== '-'): ?>
                                                    <span class="cell-status status-<?php echo e($status); ?>"><?php echo e($status); ?></span>
                                                <?php else: ?>
                                    ...
                                    <?php elseif($periode === 'yearly'): ?>
                                        <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mNum => $mName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php $percentage = $row['attendance'][$mNum]; ?>
                                    ...
                                    <td style="font-weight: 700; background:#f9fefb; color:#0f766e;"><?php echo e($row['summary']); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="<?php echo e(count($dates) + count($months) + 3); ?>" style="text-align:center; color:#9ca3af; padding: 30px 0;">Belum ada santri atau data absensi pada filter terpilih.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
...
<?php /**PATH C:\xampp\htdocs\masjid-baginda\resources\views/tpq/laporan.blade.php ENDPATH**/ ?>