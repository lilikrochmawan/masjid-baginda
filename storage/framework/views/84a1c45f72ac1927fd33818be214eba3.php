...
<body>
    ...
    <main class="main">
        ...
        <div class="tabs-nav">
            ...
            <a href="<?php echo e(route('tpq.keuangan.rekap.index')); ?>" class="tab-btn active">Rekap SPP</a>
        ...
        <div class="section">
            ...
            <form class="filters" action="<?php echo e(route('tpq.keuangan.rekap.index')); ?>" method="GET">
                <label>
                    Bulan
                    <select name="month">
                        ...
                        <?php for($m = 1; $m <= 12; $m++): ?>
                            ...
                            ?>
                            <option value="<?php echo e($m); ?>" <?php echo e($month == $m ? 'selected' : ''); ?>><?php echo e($monthName); ?></option>
                        <?php endfor; ?>
                    </select>
                </label>
                <label>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e(date('d-m-Y', strtotime($pay->tanggal_bayar))); ?></td>
                                <td><?php echo e($pay->santri->nis ?? '-'); ?></td>
                                <td><strong><?php echo e($pay->santri->nama_santri); ?></strong></td>
                                <td>
                                    <?php if($pay->santri->kelas): ?>
                                        <span><?php echo e($pay->santri->kelas->nama_kelas); ?></span>
                                    <?php else: ?>
                                        <span style="color:#9ca3af; font-style:italic;">Tanpa Kelas</span>
                                    <?php endif; ?>
                                </td>
                                <td><?php echo e($bulanName); ?> <?php echo e($pay->tahun); ?></td>
                                <td><strong>Rp <?php echo e(number_format($pay->jumlah, 0, ',', '.')); ?></strong></td>
                                <td><?php echo e($pay->user->name ?? '-'); ?></td>
                                <td>
                                    <form action="<?php echo e(route('tpq.keuangan.spp.broadcast', $pay->id)); ?>" method="POST" style="display:inline;">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\masjid-baginda\resources\views/tpq/keuangan/rekap.blade.php ENDPATH**/ ?>