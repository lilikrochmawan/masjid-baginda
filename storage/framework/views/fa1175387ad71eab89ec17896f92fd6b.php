                        ...
                        <select id="tb_kelas_id" name="tb_kelas_id" onchange="this.form.submit()">
                            <?php $__empty_1 = true; $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <option value="<?php echo e($c->id); ?>" <?php echo e($selectedClassId == $c->id ? 'selected' : ''); ?>>
                                    <?php echo e($c->nama_kelas); ?> (Pengampu: <?php echo e($c->gurus->isNotEmpty() ? $c->gurus->pluck('nama_guru')->implode(', ') : 'Belum ditentukan'); ?>)
                                </option>
        ...
        <?php if($selectedClassId): ?>
            <div class="section">
                ...
                <?php if($santris->isNotEmpty()): ?>
                    <form id="attendance-form" action="<?php echo e(route('tpq.absensi.store')); ?>" method="POST" onsubmit="confirmSave(event)">
                        <?php echo csrf_field(); ?>
                                    ...
                                    <?php $__currentLoopData = $santris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $santri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if($absen): ?>
                                                    <span class="status-badge badge-<?php echo e($currentStatus); ?>"><?php echo e($currentStatus === 'H' ? 'Hadir' : ($currentStatus === 'S' ? 'Sakit' : ($currentStatus === 'I' ? 'Izin' : 'Alpa'))); ?></span>
                                                <?php endif; ?>
                                            </td>
                                            <td style="text-align: center; vertical-align: middle;">
                                                <div class="radio-group" style="justify-content: center;">
                                                    <label class="radio-option" style="color: #166534;">
                                                        <input type="radio" name="absensi[<?php echo e($santri->id); ?>]" value="H" <?php echo e($currentStatus === 'H' ? 'checked' : ''); ?>> H
                                                    </label>
                                                    <label class="radio-option" style="color: #854d0e;">
                                                        <input type="radio" name="absensi[<?php echo e($santri->id); ?>]" value="S" <?php echo e($currentStatus === 'S' ? 'checked' : ''); ?>> S
                                                    </label>
                                                    <label class="radio-option" style="color: #1e40af;">
                                                        <input type="radio" name="absensi[<?php echo e($santri->id); ?>]" value="I" <?php echo e($currentStatus === 'I' ? 'checked' : ''); ?>> I
                                                    </label>
                                                    <label class="radio-option" style="color: #991b1b;">
                                                        <input type="radio" name="absensi[<?php echo e($santri->id); ?>]" value="A" <?php echo e($currentStatus === 'A' ? 'checked' : ''); ?>> A
                                                    </label>
                                                </div>
                                            </td>
                                            <td>
