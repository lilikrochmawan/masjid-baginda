...
<body>
    <div class="navbar">
        <div class="navbar-brand">
            <img src="<?php echo e($logoImage); ?>" alt="Logo" style="height: 36px; width: auto; object-fit: contain; border-radius: 6px; vertical-align: middle;">
            Masjid Baginda
        </div>
        <button type="button" class="menu-toggle" id="menuToggle">☰</button>
        <div class="navbar-menu" id="navbarMenu">
            <button type="button" id="profileToggle" class="profile-toggle">
                <span class="profile-icon"><?php echo e(strtoupper(substr($user->name, 0, 1))); ?></span>
                <span>Akun Saya</span>
                <span>▾</span>
            </button>

            <div class="profile-dropdown<?php echo e($errors->any() || session('success') ? ' active' : ''); ?>" id="profileDropdown">
                <div class="profile-dropdown-header">
                    ...
                    <div class="profile-dropdown-role"><?php echo e(ucfirst($hakakses->nama_hakakses)); ?></div>
                </div>

                <!-- Collapsible Password Form Section -->
                <div class="password-form-collapse<?php echo e($errors->any() || session('success') ? ' show' : ''); ?>" id="passwordFormCollapse">
                ...
                <div class="profile-dropdown-footer">
                    ...
                    <form action="<?php echo e(route('logout')); ?>" method="POST" style="margin: 0; flex: 1;">
                        <?php echo csrf_field(); ?>
    ...
    <div class="container">
        <div class="dashboard-header">
            <h2>Ahlan wa sahlan, <?php echo e($user->name); ?>! 👋</h2>
        </div>
        ...
        <div class="dashboard-layout" style="display: grid; grid-template-columns: 1.2fr 1fr; gap: 30px; margin-bottom: 40px; margin-top: 20px;">
            ...
            <div class="dashboard-card slideshow-container" style="justify-content: space-between;">
                ...
                <div class="slider-wrapper" style="position: relative; width: 100%; aspect-ratio: 16/9; overflow: hidden; border-radius: 12px; border: 1px solid #e2e8f0; background:#f8fafc;">
                    <?php if($pengumumanList->isEmpty()): ?>
                        <div class="mySlides fade" style="display: block; width: 100%; height: 100%;">
                            <img src="<?php echo e(asset('images/default_announcement.png')); ?>" style="width:100%; height:100%; object-fit: cover;" alt="Welcome Announcement">
                        </div>
                    <?php else: ?>
                        <?php $__currentLoopData = $pengumumanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="mySlides fade" style="display: <?php echo e($index === 0 ? 'block' : 'none'); ?>; width: 100%; height: 100%; position: relative;">
                                <img src="<?php echo e(asset('storage/' . $item->image_path)); ?>" style="width:100%; height:100%; object-fit: cover;" alt="<?php echo e($item->title ?? 'Announcement'); ?>">
                                <?php if($item->title): ?>
                ...
                <?php if($pengumumanList->count() > 1): ?>
                    ...
                    <div style="text-align:center; margin-top: 15px;">
                        <?php $__currentLoopData = $pengumumanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="dot <?php echo e($index === 0 ? 'active' : ''); ?>" onclick="currentSlide(<?php echo e($index + 1); ?>)" style="cursor: pointer; height: 10px; width: 10px; margin: 0 4px; background-color: #cbd5e1; border-radius: 50%; display: inline-block; transition: background-color 0.6s ease;"></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="dashboard-card dashboard-content">
                ...
                <div class="menu-grid-container" style="flex: 1;">
                    <?php if($user->hasAccess('users')): ?>
                        <a href="<?php echo e(route('users.index')); ?>" class="menu-item-compact item-user">
                    ...
                    <?php if($user->hasAccess('koin')): ?>
                        <a href="<?php echo e(route('koin.index')); ?>" class="menu-item-compact item-koin">
                            <div class="menu-item-icon-compact">🥫</div>
                            <div style="flex: 1; min-width: 0;">
                    ...
                    <?php if($user->hasAccess('operasional')): ?>
                        <a href="<?php echo e(route('operasional.dashboard')); ?>" class="menu-item-compact item-op">
                            <div class="menu-item-icon-compact">📋</div>
                            <div style="flex: 1; min-width: 0;">
                    ...
                    <?php if($user->hasAccess('keuangan')): ?>
                        <a href="<?php echo e(route('keuangan.index')); ?>" class="menu-item-compact item-keu">
                            <div class="menu-item-icon-compact">💰</div>
                            <div style="flex: 1; min-width: 0;">
                    ...
                    <?php if($user->hasAccess('tpq')): ?>
                        <a href="<?php echo e(route('tpq.dashboard')); ?>" class="menu-item-compact item-tpq">
                            <div class="menu-item-icon-compact">📚</div>
                            <div style="flex: 1; min-width: 0;">
                    ...
                    <?php if($user->hasAccess('tentang')): ?>
                        <a href="<?php echo e(route('settings.index')); ?>" class="menu-item-compact item-about">
