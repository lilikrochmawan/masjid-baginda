...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="{{ route('koin.index') }}" class="active">
...
@endif
    ...
    <main class="main">
        ...
        <div class="stats">
            <div class="stat-card"><h2>Total Kaleng</h2><div class="stat-value">{{ $stats['kaleng'] }}</div></div>
            <div class="stat-card"><h2>Total Pemilik</h2><div class="stat-value">{{ $stats['pemilik'] }}</div></div>
            <div class="stat-card"><h2>Total Transaksi</h2><div class="stat-value">{{ $stats['transaksi'] }}</div></div>
        </div>
        ...
        <div class="module-grid">
            <div class="module-card">
                ...
                @if(auth()->user()->hasAccess('koin.inventory'))
<a class="module-button" href="{{ route('koin.inventory') }}">Buka</a>
@endif
            </div>
            <div class="module-card">
                <div class="module-link">👤</div>
                ...
                @if(auth()->user()->hasAccess('koin.pemilik'))
<a class="module-button" href="{{ route('koin.pemilik') }}">Buka</a>
@endif
            </div>
            <div class="module-card">
                <div class="module-link">📷</div>
                ...
                @if(auth()->user()->hasAccess('koin.scan'))
<a class="module-button" href="{{ route('koin.scan') }}">Scan</a>
@endif
            </div>
            <div class="module-card">
                <div class="module-link">🧾</div>
                ...
                @if(auth()->user()->hasAccess('koin.penerimaan'))
<a class="module-button" href="{{ route('koin.penerimaan.create') }}">Input</a>
@endif
            </div>
            <div class="module-card">
                <div class="module-link">�📊</div>
                ...
                @if(auth()->user()->hasAccess('koin.laporan'))
<a class="module-button" href="{{ route('koin.laporan') }}">Lihat</a>
@endif
            </div>
        </div>
    </main>
