    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media print {
            ...
            td, th { border-bottom: 1px solid #cbd5e1; padding: 10px 8px; font-size: 12px; }
...
<body>
    ...
    <main class="main">
        ...
        <div class="section">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px; margin-top: 28px; flex-wrap: wrap; gap: 12px; border-bottom: 1px solid #e6f4ed; padding-bottom: 12px;">
                <h3 style="color:#0f4d36; font-size:15px; margin-bottom: 0;">Rincian Transaksi Kas Periode: {{ date('d/m/Y', strtotime($startDate)) }} s/d {{ date('d/m/Y', strtotime($endDate)) }}</h3>
                <input type="text" id="tableSearchInput" placeholder="Cari rincian kas..." style="padding: 10px 14px; border-radius: 10px; border: 1px solid #d1e7dd; font-size: 13.5px; background: #fbfffe; color: #103a2d; min-width: 200px; outline: none; transition: border-color 0.2s;">
            </div>
        ...
        function updateTable() {
            ...
            if (filteredRows.length === 0) {
                if (!noDataRow) {
                    ...
                    noDataRow.innerHTML = '<td colspan="6" style="text-align:center; color:#9ca3af; padding: 20px 0;">Tidak ada transaksi kas yang cocok.</td>';
