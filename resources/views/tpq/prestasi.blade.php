                ...
                <div style="display: flex; gap: 16px; margin-bottom: 20px; flex-wrap: wrap;">
                    ...
                    <div style="flex: 1; min-width: 200px; background: #fff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 16px; display: flex; align-items: center; gap: 16px;">
                        ...
                        <div>
                            ...
                            <div style="font-size: 22px; font-weight: 700; color: #0f172a; line-height: 1;">{{ $countSoroganToday }}</div>
                    ...
                    <div style="flex: 1; min-width: 200px; background: #fff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 16px; display: flex; align-items: center; gap: 16px;">
                        ...
                        <div>
                            ...
                            <div style="font-size: 22px; font-weight: 700; color: #0f172a; line-height: 1;">{{ $countHafalanToday }}</div>
